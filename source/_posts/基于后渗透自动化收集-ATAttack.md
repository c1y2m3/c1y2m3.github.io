---
title: 基于后渗透自动化收集-ATAttack
date: 2019-10-15 11:51:24
...
![img](https://www.yunzhijia.com/microblog/filesvr/5e1c398932f2ca5a1c43e852)

## 快照预览

## win10测试环境

![img](https://www.yunzhijia.com/microblog/filesvr/5dbe4d62b54c8d19b5579f55)

## win2008测试环境：

![img](https://www.yunzhijia.com/microblog/filesvr/5dac6de090144e463b1d6194)
...
5、在当前用户文件夹下查找获取指定文件，如word、pdf、txt、csv等

## 二、主机网段收集:

1、基于提取系统远程连接记录，如：远程桌面，arp缓存，windows系统日志(4624、4625)等

（浏览器浏览记录、单机系统进程记录，系统登录日志记录提取IP）
